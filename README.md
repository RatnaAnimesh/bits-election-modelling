...
│   ├── 02_Core_Dynamics.ipynb
│   ├── 03_Advanced_Dynamics.ipynb
│   ├── 04_Advanced_Turnout.ipynb
...
*   `data/junior_senior.csv`: Contains data on the relationships between juniors and seniors.
*   `data/ssms_election_results.csv`: Contains the results of the SSMS elections.
*   `data/mess_reps.csv`: Contains data on the mess representatives.
*   `data/amc_members.csv`: Contains data on the AMC members.

The following data files still need to be created:

*   `data/past_hreps.csv`: This file will contain the data on the past H-reps.
*   `data/past_mreps.csv`: This file will contain the data on the past M-reps.
